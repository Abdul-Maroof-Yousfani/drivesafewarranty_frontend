...
export default function EditWarrantyPackagePage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      if (itemsRes.status && Array.isArray(itemsRes.data)) {
        setWarrantyItems(itemsRes.data.map((x) => ({ id: x.id, label: x.label, type: x.type })));
      }
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Edit Warranty Package</h1>
        <p className="text-muted-foreground mt-2">Update warranty package details</p>
      </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Short description of this package" rows={3} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Eligibility criteria" rows={2} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
