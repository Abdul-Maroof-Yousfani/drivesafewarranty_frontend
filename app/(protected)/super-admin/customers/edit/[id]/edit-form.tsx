...
const vehicleSchema = z.object({
  ...
  vin: z.string().min(1, "VIN is required").length(17, "VIN must be exactly 17 characters"),
  registrationNumber: z.string().min(1, "Registration number is required").regex(/^[A-Z0-9\s]{5,8}$/i, "Invalid Registration Number format"),
