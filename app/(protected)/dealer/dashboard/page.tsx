      ...
      <Card>
        ...
        <CardContent>
          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
            <Button className="w-full justify-start" asChild disabled={isInactive || statusLoading}>
              {isInactive || statusLoading ? (
            ...
            <Button variant="outline" className="w-full justify-start" asChild disabled={isInactive || statusLoading}>
              {isInactive || statusLoading ? (
                <div className="flex items-center w-full opacity-50 cursor-not-allowed">
