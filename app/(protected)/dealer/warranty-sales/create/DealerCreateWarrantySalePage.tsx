...
export default function DealerCreateWarrantySalePage() {
  ...
  useEffect(() => {
    if (!statusLoading && isInactive) {
      toast.error("Your account is in view-only mode. Access denied.");
      router.push("/dealer/dashboard");
    }
  }, [isInactive, statusLoading, router]);
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="date" {...field} disabled={isInactive} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="flex gap-4">
                <Button
                  type="submit"
                  disabled={loading || !pkg || eligibilityStatus?.eligible === false || isInactive}
                >
                  {loading ? "Assigning..." : isInactive ? "View Only Mode" : "Assign Package"}
                </Button>
                <Button
                  type="button"
                  variant="outline"
