...
import { Plus, Trash2, Edit, Car, Save, ChevronDown, ChevronUp } from "lucide-react";
          ...
          <Form {...profileForm}>
            ...
            >
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input maxLength={50} {...field} disabled={isInactive || profileLoading} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} disabled={isInactive || profileLoading} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="email" maxLength={100} {...field} disabled={isInactive || profileLoading} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input maxLength={13} placeholder="e.g. 07123456789" {...field} disabled={isInactive || profileLoading} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea maxLength={200} {...field} disabled={isInactive || profileLoading} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <div className="flex justify-end">
                <Button type="submit" disabled={profileLoading || isInactive}>
...
function VehicleForm({
  ...
  onCancel,
  disabled
}: VehicleFormProps & { disabled?: boolean }) {
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} disabled={!!initialData?.id || disabled} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    disabled={!!initialData?.id || disabled}
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
