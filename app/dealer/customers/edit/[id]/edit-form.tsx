        ...
        <div className="space-y-6 max-w-4xl mx-auto">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground mt-2">Manage customer details and vehicles</p>
                </div>
            </div>
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    <div>
                        ...
                        <CardDescription className="mt-1">Manage customer vehicles</CardDescription>
                    </div>
                    <Button onClick={() => {
                        setEditingVehicle(null);
                ...
                <CardContent className="space-y-4">
                    {vehicles.length === 0 ? (
                        <p className="text-muted-foreground text-center py-4">No vehicles found.</p>
                    ) : (
                        vehicles.map((vehicle, index) => (
                            <div key={vehicle.id || index} className="flex items-center justify-between p-4 border rounded-lg bg-card">
            ...
            <Dialog open={isVehicleDialogOpen} onOpenChange={setIsVehicleDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>{editingVehicle ? "Update vehicle details." : "Add a new vehicle to this customer."}</DialogDescription>
                    </DialogHeader>
                    <VehicleForm
...
function VehicleForm({
    ...
    const onSubmit = async (data: VehicleValues) => {
        ...
        try {
            ...
            if (initialData?.id) {
                // Update
                result = await updateDealerCustomerVehicleAction(initialData.id, data);
            } else {
                // Create
                result = await createDealerCustomerVehicleAction(customerId, data);
            }
