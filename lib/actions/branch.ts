    ...
    return {
      ...
      message:
        error instanceof Error
          ? error.message
          : "Failed to fetch branches. Please check your connection.",
    };
  }
}
...
export async function getBranchById(
  id: string
): Promise<{ status: boolean; data?: Branch; message?: string }> {
  try {
    ...
    if (!res.ok) {
      const errorData = await res
        .json()
        .catch(() => ({ message: "Failed to fetch branch" }));
      return {
        status: false,
        message: errorData.message || `HTTP error! status: ${res.status}`,
      };
...
export async function createBranch(data: {
  ...
  try {
    ...
    if (!res.ok) {
      const errorData = await res
        .json()
        .catch(() => ({ message: "Failed to create branch" }));
      return {
        status: false,
        message: errorData.message || `HTTP error! status: ${res.status}`,
      };
...
export async function createBranchesBulk(
  ...
  try {
    ...
    if (!res.ok) {
      const errorData = await res
        .json()
        .catch(() => ({ message: "Failed to create branches" }));
      return {
        status: false,
        message: errorData.message || `HTTP error! status: ${res.status}`,
      };
    ...
    return {
      status: false,
      message:
        error instanceof Error ? error.message : "Failed to create branches",
    };
  }
}
...
export async function updateBranch(
  id: string,
  data: { name: string; address?: string; cityId?: string; status?: string }
): Promise<{ status: boolean; data?: Branch; message?: string }> {
  try {
    const res = await fetch(`${API_URL}/branches/${id}`, {
      method: "PUT",
    ...
    if (!res.ok) {
      const errorData = await res
        .json()
        .catch(() => ({ message: "Failed to update branch" }));
      return {
        status: false,
        message: errorData.message || `HTTP error! status: ${res.status}`,
      };
...
export async function updateBranchesBulk(
  items: {
    id: string;
    name: string;
    address?: string;
  ...
  try {
    ...
    if (!res.ok) {
      const errorData = await res
        .json()
        .catch(() => ({ message: "Failed to update branches" }));
      return {
        status: false,
        message: errorData.message || `HTTP error! status: ${res.status}`,
      };
    ...
    return {
      status: false,
      message:
        error instanceof Error ? error.message : "Failed to update branches",
    };
  }
}
...
export async function deleteBranches(
  ...
  try {
    ...
    if (!res.ok) {
      const errorData = await res
        .json()
        .catch(() => ({ message: "Failed to delete branches" }));
      return {
        status: false,
        message: errorData.message || `HTTP error! status: ${res.status}`,
      };
